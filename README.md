...
* Control via keyboard:
  * Q, W, E, R, T – increase the joint values for waist, shoulder, elbow, pitch and roll, respectively,
  * A, S, D, F, G – decrease the joint values for waist, shoulder, elbow, pitch and roll, respectively,
